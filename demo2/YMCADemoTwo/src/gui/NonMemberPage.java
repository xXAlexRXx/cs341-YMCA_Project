...
public class NonMemberPage extends JFrame {
    ...
    public NonMemberPage(User user) {
    ...
    private void initializeComponents() {
        ...
        accountButton.setFont(new Font("Tahoma", Font.PLAIN, 14));
        accountButton.setBounds(862, 71, 85, 21);
        startUpPane.add(accountButton);

        accountButton.addActionListener(e -> {
            new AccountPage(currentUser).setVisible(true);
            // Optionally close the MemberPage window:
            // dispose();
        });
